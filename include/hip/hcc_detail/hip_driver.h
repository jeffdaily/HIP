...
#else
typedef hipDeviceptr_t HUdeviceptr;
typedef hipDevice_t HUdevice;
typedef hipCtx_t HUcontext;
typedef hipModule_t HUmodule;
typedef hipFunction_t HUfunction;
typedef hipArray_t HUarray;
typedef hipMipmappedArray_t HUmipmappedArray;
typedef textureReference *HUtexref;
typedef struct HUsurfref_st *HUsurfref; // not implemented
typedef hipEvent_t HUevent;
typedef hipStream_t HUstream;
typedef struct HUgraphicsResource_st *HUgraphicsResource; // not implemented
typedef hipTextureObject_t HUtexObject;
typedef hipSurfaceObject_t HUsurfObject;
#endif
